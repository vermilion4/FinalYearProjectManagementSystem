...
<head>
    ...
    <link href="css/css/Private_Chat_Style.css" rel="stylesheet"/>
    <link href="css/css/jquery.yacal.css" rel="stylesheet"/>
...
<span style="margin-top:3px"><strong><?php echo ($_SESSION["usrnm"]); ?></strong></span>
</div>
</div>
...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <li><a href="General_Message.php"><img src="img/chat-1.png" class="navimg img-responsive" /><span class="nav-writting">Public Chat</span></a></li>
           ...
           <li><a href="Main_Dashboard.php"><img src="img/logout.png" class="navimg img-responsive" /><span class="nav-writting">Back</span></a></li>
            <li onclick="Logout()"><a href="home.php"><img src="img/logout.png" class="navimg img-responsive" /><span class="nav-writting">Logout</span></a></li>
        </ul>
    </div>
  ...
  <?php
        ...
        if(isset($_POST["send_message"])){
          if(!empty($_POST["txtmessage"])){
            $messageSender = $_SESSION["usrnm"];
            $newmessage = mysqli_real_escape_string($connection_String, $_POST["txtmessage"]);
             //$perfect_table = $_COOKIE["correctTable"];
            $query = "INSERT INTO correctTable ( Usernames, Messages )VALUES ('$messageSender','$newmessage')";
        ...
        $update_profile_query = "UPDATE users_table SET Profile_Picture = '$myfiles' WHERE user_fname ='$selected_username'";
...
<script src="css/js/jquery-3.1.1.min.js"></script>
 ...
 <script src="css/js/jquery.yacal.min.js"></script>
