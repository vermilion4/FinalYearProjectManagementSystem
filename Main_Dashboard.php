...
<head>
    ...
    <script src="css/js/lumino.glyphs.js"></script>
...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <li onclick="Logout()"><a href="home.php"><img src="img/logout.png" class="navimg img-responsive" /><span class="nav-writting">Back</span></a></li>
        </ul>
    </div>
 ...
 <script src="css/js/bootstrap.min.js"></script>
   <script src="css/js/chart.min.js"></script>
  <script src="css/js/chart-data.js"></script>
  <script src="css/js/easypiechart.js"></script>
  <script src="css/js/easypiechart-data.js"></script>
