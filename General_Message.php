...
<head>
    ...
    <link href="css/css/style.css" rel="stylesheet" rel="stylesheet"/>
    <link href="css/css/css/style.css" media="all" rel="stylesheet"/>
    ...
    <script type="text/javascript" src="css/js/jquery.yacal.min.js"></script>
  ...
  <!-- Side bar begins -->
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <li><a href="Private_Message.php"><img src="img/send-file.png" class="navimg img-responsive" /><span class="nav-writting">Private Chat</span></a></li>
           
           <li onclick="Logout()"><a href="Main_Dashboard.php"><img src="img/logout.png" class="navimg img-responsive" /><span class="nav-writting">Back</span></a></li>
        </ul>
    </div>
    ...
    $selected_username = $_SESSION["usernm"];
